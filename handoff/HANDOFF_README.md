...
مجموعة من **الأماكن الحقيقية بمدينة دبي** (مطاعم، مستشفيات، حدائق، بارات، صيدليات، محطات مواصلات...)، مسحوبة من **OpenStreetMap** عبر Overpass API. هذه البيانات تغذّي ميزة **"Neighborhood Vibe Report"** حساب درجات الأمان والهدوء والخدمات بمحيط 500 متر حول أي عقار.
...
الملف عبارة عن ** JSON**، كل عنصر فيها بهذا الشكل:
...
كل فئة تغذّي بُعداً مختلفاً من أبعاد الـ **VibeReport** الثلاثة الموصوفة بالـ Class Diagram 
